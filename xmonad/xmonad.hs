...
--((mod, xK_g), goToSelected defaultGSConfig)
  ((mod .|. shiftMask, xK_b), spawn "/lsc/opt/bin/chromium-browser")
  ...
  , ((mod .|. shiftMask, xK_s), spawn "skype")
  , ((mod .|. shiftMask, xK_i), spawn "VirtualBox")
  , ((mod .|. shiftMask, xK_a), spawn "mathematica")
  , ((mod .|. shiftMask, xK_t), spawn "thunderbird")
  , ((mod .|. shiftMask, xK_r), spawn "rhythmbox")
  , ((mod .|. shiftMask, xK_o), spawn "owncloud")
